			...
			<form @submit="formSubmit">
				<view class='form-body'>
					...
					<view class='row font-lv2 overHidden'>
						...
						<view class='col-5'>
							<input @input="getTelNumber" name="username" type="number" auto-focus='true' placeholder="请输入电话号码" />
						</view>
				...
				<view class='row'>
					<button class='btn-submit btn-block login-button' :loading='loading' form-type='submit'> 确认登陆 </button>
				</view>
				<!-- #ifdef MP-WEIXIN -->
				<!-- <view class="row">
				...
				<!-- #endif -->
				<view class='row'>
					<button @click="toReg" class='btn-login btn-block login-button'> 注册账号 </button>
				</view>
			</form>
		</view>
	</view>
